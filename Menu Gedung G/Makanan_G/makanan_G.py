...
ASSETS_PATH = OUTPUT_PATH / Path(r"D:/App_Danus/Menu Gedung G/Makanan_G/assets/frame0")
...
window = Tk()
window.title("MENU MAKANAN GEDUNG G")
...
def btn_clicked():
    ...
    window.destroy()
    subprocess.call(["python", "D:\App_Danus\Menu Gedung G\Minuman_G\minuman_G.py"])
